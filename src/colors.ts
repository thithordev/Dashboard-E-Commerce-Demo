...
export const colorsBgLight: ColorsBg = {
...
export interface ColorsOutline {
  white: string[];
  light: string[];
  contrast: string[];
  success: string[];
...
export const colorsOutline: ColorsOutline = {
...
interface Colors {
    ...
    bgHover: { [key: string]: string };
    borders: { [key: string]: string };
    text: { [key: string]: string };
    outlineHover: { [key: string]: string };
  }

export const getButtonColor = (color: string, isOutlined: boolean, hasHover: boolean, isActive = false) => {
  const colors: Colors = {
    ring: {
